 ...
 *	Conditionalize based on SLOWSEND. Turn on SLOWSEND by default.
 *
 *  9-May-89  Peter King (king) at NeXT
 *	Sun Bugfixes: 1005918 - Free whole mbuf chain on error, not just
 *				first mbuf.  Was causing nfsd's to get
 *				swapped out.
 *		      1010947 - If udpcksum is set, compute checksums.
 *		      1010337 - Fix bad IP checksums.
 *
