/*
 * Zilog 8530 controller register definitions.
 */

/*
 * The 8530 contains the following registers:
...
struct zsdevice {
	u_char	zs_ctrl;	/* control register */
	u_char	:8;
	u_char	zs_data;	/* data register */
	u_char	:8;
};
 ...
 */
#ifndef DELAY
#define	DELAY(x)	{ register int X=(x)>>1; while (--X > 0); }
#endif !DELAY
...
/*
 * FIXME: this crap should not be here!
 */
