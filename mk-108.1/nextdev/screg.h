 ...
 *
 * HISTORY
 * 08-Feb-89	Doug Mitchell at NeXT
 *	Added config2 register for 53C90A.
...
#define	s5r_syncoffset	s5r_fifoflags	/* 0x7: WRITE: sync offset */
	...
	u_char	s5r_config2;		/* 0xb: config2 (53C90A only) */
	u_char	s5r_pad[0x14];		/* 0xc - 0x1f: not used */
...
/* 
 * config2 register (only valid for 53C90A)
 */
#define S5RCNF2_TRIDR		0x10	/* Tristate DMA REQ */
#define S5RCNF2_SCSI2		0x08	/* SCSI2 mode enable */
#define S5RCNF2_TBPA		0x04	/* Target bad parity abort */
#define S5RCNF2_REGPAR		0x02	/* register parity passes thru fifo */
#define S5RCNF2_DMAPAR		0x01	/* DMA parity passes thru fifo */
#define S5RCNF2_TESTMASK	0x0F	/* these bits can be tested to see */
					/* if this chip is a 53C90A */
