 ...
 *	NeXT: NFS 4.0 Changes:  Make sure this doesn't get compiled for VFS.
 * 
 * Revision 2.4  89/03/09  22:06:56  rpd
 * 	More cleanup.
 * 
 * Revision 2.3  89/02/25  17:55:42  gm0w
 * 	Changes for cleanup.
 * 
...
extern struct	quota *quota, *quotaNQUOTA;
extern int	nquota;
extern struct	quota *getquota(), *qfind();
...
extern int	ndquot;
extern struct	dquot *discquota(), *inoquota(), *dqalloc(), *dqp();
#endif	defined(KERNEL) && QUOTA
