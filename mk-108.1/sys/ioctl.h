 ...
 *	Added SIOCBROAD to enable udp broadcast.
 */
...
#if	NeXT
#define		EUCBKSP		0x00080000	/* EUC backspace processing */
#else	NeXT
...
#define		TIOCPKT_IOCTL		0x40	/* pty driver state change */
...
#define	TIOCSCONS	_IO('t', 104)		/* 4.2 compatibility */
...
#define	SIOCAUTOADDR	_IOWR('i', 33, struct ifreq)	/* autoconf addr */
#define SIOCAUTONETMASK	_IOW('i', 34, struct ifreq)	/* autoconf netmask */
